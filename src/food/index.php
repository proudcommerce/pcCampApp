...
<div class="page-wrap container">
  <h1 data-i18n="pageTitle.food"></h1>
  <div class="food">
    <div id="menu-container" data-i18n="loading.menu"></div>

    <details>
      <summary data-i18n="food.allergensTitle"></summary>
      <div class="meal-content">
        <br>
        <div id="allergens-list" data-i18n="loading.allergens"></div>
      </div>
    </details>
  </div>
